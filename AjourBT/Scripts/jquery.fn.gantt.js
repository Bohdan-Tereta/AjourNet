...
(function ($, undefined) {
    ...
    $.fn.gantt = function (options) {
        ...
        var TimeZoneOffsetmilliseconds = new Date().getTimezoneOffset() * 60000;
            ...
            init: function (element) {
                $.each(element.data, function (i, entry) {
                    $.each(entry.values, function (j, day) {
                        day.from = tools.dateDeserialize(day.from).getTime() - TimeZoneOffsetmilliseconds;
                        day.to = tools.dateDeserialize(day.to).getTime() - TimeZoneOffsetmilliseconds;
                    })
                });
        ...
        var tools = {
            ...
            _datesToDays: function (dates) {
                ...
                for (var i = 0, len = dates.length, day; i < len; i++) {
                    day = new Date(tools.dateDeserialize(dates[i]).getTime() - TimeZoneOffsetmilliseconds);
